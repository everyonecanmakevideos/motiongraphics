...
export const IndiaMapConnectSchema = z.object({
  ...
  routeColor: HexColor.default("#F4B942"),
  nodeColor: HexColor.default("#F8FAFC"),
...
export type IndiaMapConnectProps = z.infer<typeof IndiaMapConnectSchema>;
