...
export const CITY_CATALOG: readonly CityCatalogEntry[] = [
  ...
  { canonical: "Kolkata", aliases: ["kolkata", "calcutta"], region: "india" },
  ...
  { canonical: "Kochi", aliases: ["kochi", "cochin"], region: "india" },
  {
...
export const CITY_FALLBACK_COORDS: Record<string, { x: number; y: number }> = {
  ...
  Delhi: { x: 60, y: 45 },
  Kochi: { x: 58, y: 60 },
  Thiruvananthapuram: { x: 59, y: 63 },
  Kerala: { x: 58, y: 58 },
  Haryana: { x: 59, y: 43 },
  Punjab: { x: 57, y: 41 },
  Karnataka: { x: 59, y: 54 },
  "Tamil Nadu": { x: 62, y: 60 },
  Maharashtra: { x: 57, y: 50 },
  Telangana: { x: 62, y: 50 },
  "Andhra Pradesh": { x: 64, y: 52 },
  Gujarat: { x: 54, y: 46 },
  Rajasthan: { x: 53, y: 42 },
  "Uttar Pradesh": { x: 63, y: 43 },
  "West Bengal": { x: 67, y: 45 },
  Singapore: { x: 68, y: 58 },
  Tokyo: { x: 81, y: 35 },
  Seoul: { x: 78, y: 33 },
  "Hong Kong": { x: 74, y: 47 },
